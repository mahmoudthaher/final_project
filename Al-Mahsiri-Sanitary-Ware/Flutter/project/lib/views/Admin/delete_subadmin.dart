...
class DeleteSubAdmin extends StatefulWidget {
  final VoidCallback onBack;

  const DeleteSubAdmin({required this.onBack, super.key});

  @override
  State<DeleteSubAdmin> createState() => _DeleteSubAdminState();
}

class _DeleteSubAdminState extends State<DeleteSubAdmin> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      List<UserModel> updatedUsers = await UserController().getUserByTypeId1();
      setState(() {
        users = updatedUsers;
      });
    } catch (error) {
